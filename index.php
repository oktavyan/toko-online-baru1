       ...
       <div class="main">
        	<div class="container">
                            ...
                            <div id="banner7-caption2" class="banner7-caption nivo-html-caption nivo-caption">
                                ...
                                <div class="banner7-content slider-2">
                                    <div class="title-container">
                                        ...
                                        <h2 class="title2" >Ciluk baaaaaa...!!!</h2>											
                                    </div>
                                    <div class="banner7-des">
                                   		<div class="des">
											<h1>sale up to!</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="banner banner-double"><a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-02.jpg"></a></div>
                        <div class="banner banner-double"><a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-03.jpg"></a></div>
                    </div>
                    <div class="col-sm-4">
                        <div class="banner"><a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-04.jpg"></a></div>
                    </div>
                </div><!-- /advertisement -->
                <div class="row">
                            ...
                            <div id="timely-owl" class="owl-container">
                                <div class="owl">
                                    <div class='timer-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Fusce aliquam" class="product-image"><img src="<?php echo base_url(); ?>assets/images/products/1.jpg" alt="Fusce aliquam" /></a>
                                                <div class="box-timer">
                                    ...
                                    <div class='timer-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Quisque in arcu" class="product-image"><img src="<?php echo base_url(); ?>assets/images/products/2.jpg" alt="Quisque in arcu" /></a>
                                                <div class="box-timer">
                                    ...
                                    <div class='timer-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="pleasure rationally" class="product-image"><img src="<?php echo base_url(); ?>assets/images/products/20.jpg" alt="pleasure rationally" /></a>
                                                <div class="box-timer">
                                        ...
                                        <div class="item-inner first">
                                            <div class="images-container">
                                                <a href="#" title="Primis in faucibus" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/kamera.jpeg" alt="Primis in faucibus" />
                                                </a>
                                            </div>
                                        ...
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Accumsan elit " class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/14.jpg" alt="Accumsan elit " />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/5.jpg" alt="Nunc facilisis" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner last">
                                            <div class="images-container">
                                                <a href="#" title="Fusce aliquam" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/8.jpg" alt="Fusce aliquam" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                                <h2 class="product-name"><a href="#" title="Fusce aliquam">Fusce aliquam</a></h2>
                                    ...
                                    <div class='sepecialoffer-item item'>
                                        <div class="item-inner first">
                                            <div class="images-container">
                                                <a href="h#" title="consequences" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/9.jpg" alt="consequences" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Cras neque metus" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kulkas.jpg" alt="Cras neque metus" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/products/4.jpg" alt="Etiam gravida" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner last">
                                            <div class="images-container">
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/products/9.jpg" alt="Donec non est" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner first">
                                            <div class="images-container">
                                                <a href="#" title="pleasure rationally" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/10.jpg" alt="pleasure rationally" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                                <h2 class="product-name"><a href="#" title="pleasure rationally">pleasure rationally</a></h2>
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                <a href="#" title="Aliquam consequat" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/5.jpg" alt="Aliquam consequat" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                <a href="#" title=" Donec ac tempus " class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/11.jpg" alt=" Donec ac tempus " />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner last">
                                            <div class="images-container">
                                                <a href="#" title="occaecati cupiditate" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/6.jpg" alt="occaecati cupiditate" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                            ...
                            <div id="latest-news" class="owl-container">
                                <div class="owl">
                                    <div>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#"> <img alt="" src="<?php echo base_url(); ?>assets/images/blog/blog-01.jpg" /> </a>
                                            </div>
                                            <div class="des-container">
                                    ...
                                    <div>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#"> <img alt="" src="<?php echo base_url(); ?>assets/images/blog/blog-02.jpg" /> </a>
                                            </div>
                                            <div class="des-container">
                                                <div class="date-comments">
                                ...
                                <div class="owl">
                                        ...
                                        <div class="testimonial-sidebar-content">
                                            ...
                                            <div class="post-by">
                                                <div class="testimonial-content-avatar">
                                                    <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-01.jpg" alt="test" />
                                                </div>
                                    ...
                                    <div class='testimonial-list'>
                                        <div class="testimonial-sidebar-content">
                                            ...
                                            <div class="post-by">
                                                <div class="testimonial-content-avatar">
                                                    <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-02.jpg" alt="test" />
                                                </div>
                                                <div class="box-author">
                                    ...
                                    <div class='testimonial-list'>
                                        <div class="testimonial-sidebar-content">
                                            ...
                                            <div class="post-by">
                                                <div class="testimonial-content-avatar">
                                                    <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-03.jpg" alt="test" />
                                                </div>
                                                <div class="box-author">
                    ...
                    <div class="col-sm-9 col-right">
                       ...
                       <table border="2" align="center">
                        <tr>
                            <th bgcolor="black"><font color="white"><h2><a href = "<?php echo base_url(); ?>index.php/main/tambah">Tambah Baru</a></h2></th></font>
                        </tr>
                        </table>
                          <div class="title-group1"><h2>Products</h2></div>
                           <div id="featured-products" class="owl-container">
                           <div class="owl">
                           <?php foreach ($data as $item) : ?>

                            <!--<?php $image = explode("/",$item->gambar); ?>-->
                                 ...
                                 <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                    <img src="<?php echo base_url($item->gambar); ?>" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="<?php echo base_url(); ?>index.php/main/detail" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/<?php echo $item->id; ?>" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                                <h2 class="product-name"><a href="#" title="Nunc facilisis"><?php echo $item->nama; ?></a></h2>
                                                <div class="price-box">
                                                    <p class="special-price">
                                                        <span class="price-label">Special Price</span>
                                                ...
                                                <div class="ratings">
                                                    ...
                                                    <span class="amount"><a href="#"><?= $item->lihat; ?>Review(S)</a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kulkas.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        ...
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/1" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                                <h2 class="product-name"><a href="#" title="Nunc facilisis">Kulkas 1</a></h2>
                                                <div class="price-box">
                                                    <p class="special-price">
                                                        <span class="price-label">Special Price</span>
                                                        <span class="price">$169.99</span>
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kamera.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/2" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                                <h2 class="product-name"><a href="#" title="Nunc facilisis">Kamera</a></h2>
                                                <div class="price-box">
                                                    <p class="special-price">
                                                        <span class="price-label">Special Price</span>
                                                        <span class="price">$169.99</span>
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/nikon.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/3" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kamera1.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/main/cart/1" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                            ...
                                            <div class="images-container">
                                                ...
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        ...
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href='<?php echo base_url(); ?>index.php/main/cart' class="link-cart"> Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                    	...
                    	<div class="banner">
                        	<a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-05.jpg"></a>
                        </div>
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kkuning.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kkecil.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/4" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kirin.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href='<?php echo base_url(); ?>index.php/keranjang/additem/5' class="link-cart"> Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/kulkas1.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                                                        <li><a href="#" class="link-wishlist">Add to Wishlist</a></li>
                                                        <li><a href="#" class="link-compare">Add to Compare</a></li>
                                                        <li><a href="<?php echo base_url(); ?>index.php/keranjang/additem/6" class="link-cart">Add to Cart</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="des-container">
                                    ...
                                    <div class='productslider-item item'>
                                        <div class="item-inner">
                                            <div class="images-container">
                                                ...
                                                <a href="#" title="Nunc facilisis" class="product-image">
                                                	<img src="<?php echo base_url(); ?>assets/images/products/7.jpg" alt="Nunc facilisis" />
                                                </a>
                                                <div class="box-hover">
                                                    <ul class="add-to-links">
                                                        <li><a href="#" class="link-quickview">Quick View</a></li>
                        ...
                        <div class="row">
                        	<div class="col-smc-7">
                            	<div class="banner">
                                	<a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-06.jpg"></a>
                                </div>
                            </div>
                            <div class="col-smc-5">
                            	<div class="banner">
                                	<a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/ads/ads-07.jpg"></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        	<div class="col-sm-4">
                                ...
                                <div class="product-list">
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/ali1.jpg"></a>
										</div>
										<div class="des-container">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/ali2.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
											<div class="ratings">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/ali3.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
											<div class="ratings">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="product-list">
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/iphone.jpg"></a>
										</div>
										<div class="des-container">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/xia1.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Demonstraverunt lectores</a></h2>
											<div class="ratings">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/xia2.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Demonstraverunt lectores</a></h2>
											<div class="ratings">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="product-list">
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/rog1.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
											<div class="ratings">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/rog2.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
											<div class="ratings">
                                	...
                                	<div class="products-grid">
										<div class="images-container">
											<a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="<?php echo base_url(); ?>assets/images/products/rog3.jpg"></a>
										</div>
										<div class="des-container">
											<h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
											<div class="ratings">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="image-cat">
                                    <a href="#/"><img alt="Electronic" src="<?php echo base_url(); ?>assets/images/products/img-05.jpg"></a>
                                </div>
                            </div>
                            <div class="col-xs-6">
                   	...
                   	<div class="col-md-3 col-sm-6">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="image-cat">
                                    <a href="#/"><img alt="Electronic" src="<?php echo base_url(); ?>assets/images/products/img-06.jpg"></a>
                                </div>
                            </div>
                            <div class="col-xs-6">
                   	...
                   	<div class="col-md-3 col-sm-6">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="image-cat">
                                    <a href="#/"><img alt="Electronic" src="<?php echo base_url(); ?>assets/images/products/img-07.jpg"></a>
                                </div>
                            </div>
                            <div class="col-xs-6">
                   	...
                   	<div class="col-md-3 col-sm-6">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="image-cat">
                                    <a href="#/"><img alt="Electronic" src="<?php echo base_url(); ?>assets/images/products/img-08.jpg"></a>
                                </div>
                            </div>
                            <div class="col-xs-6">
